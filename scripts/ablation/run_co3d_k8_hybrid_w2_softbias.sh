...
# CO3D eval using hybrid graph (±2 window + retrieval fill) with soft bias, K=8, mutual=true.
...
OUTPUT_DIR=${2:-"results/all_runs/run_co3d_k8_hybrid_w2_softbias"}
...
# Per-seq graphs: hybrid + soft bias
