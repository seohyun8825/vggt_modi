...
# CO3D eval using per-sequence graphs (MegaLoc) with mutual=false (directed), Top-K=8.
...
OUTPUT_DIR=${2:-"results/all_runs/run_co3d_k8_nomutual"}
...
# Build per-sequence graphs (directed)
