...
# CO3D eval using per-sequence graphs built with ResNet50 (Top-K=8, mutual=true), no soft bias.
...
OUTPUT_DIR=${2:-"results/all_runs/run_co3d_k8_resnet50"}
...
# Build per-sequence graphs with ResNet50 backbone
